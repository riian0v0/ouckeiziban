import 'package:a/irasuto2.dart';
...
class irasuto extends StatefulWidget {
  const irasuto({Key? key}) : super(key: key);

  @override
  State<irasuto> createState() => _irasutoState();
}

class _irasutoState extends State<irasuto> {
  @override
  Widget build(BuildContext context) {
    return FutureBuilder(
        future: FirebaseFirestore.instance.collection("irasuto").get(),
